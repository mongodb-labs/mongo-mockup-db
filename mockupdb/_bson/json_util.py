...
.. doctest::
   ...
   >>> from mockupdb._bson.json_util import loads
...
.. doctest::
   ...
   >>> from mockupdb._bson import Binary, Code
   >>> from mockupdb._bson.json_util import dumps
   >>> dumps([{'foo': [1, 2]},
   ...        {'bar': {'hello': 'world'}},
...
.. doctest::
   ...
   >>> from mockupdb._bson import Binary, Code
   >>> from mockupdb._bson.json_util import dumps, CANONICAL_JSON_OPTIONS
   >>> dumps([{'foo': [1, 2]},
   ...        {'bar': {'hello': 'world'}},
   ...        {'code': Code("function x() { return 1; }")},
   ...        {'bin': Binary(b"\x01\x02\x03\x04")}],
...
.. doctest::
   ...
   >>> from mockupdb._bson import Binary, Code
   >>> from mockupdb._bson.json_util import dumps, RELAXED_JSON_OPTIONS
   >>> dumps([{'foo': [1, 2]},
   ...        {'bar': {'hello': 'world'}},
   ...        {'code': Code("function x() { return 1; }")},
   ...        {'bin': Binary(b"\x01\x02\x03\x04")}],
...
from mockupdb._bson.codec_options import CodecOptions
...
from mockupdb._bson.py3compat import (PY3, iteritems, integer_types,
                                      string_type,
                                      text_type)
